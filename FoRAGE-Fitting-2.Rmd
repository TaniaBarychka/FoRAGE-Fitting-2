...
The simlification to remove habitat seems to be justified because it caused a negligible reduction in the explanatory power of the model (p=0.10; to retain we would need p<0.05). Step function suggests not removing habitat.
